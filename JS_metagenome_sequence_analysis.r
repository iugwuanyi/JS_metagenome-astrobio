...
#prepare taxonomy table for downstream analyses using the clean_taxonomy function above which rotates taxonomy table, so that samples are on separate columns
#samples are renamed to reflect names used in published paper
...
write.csv(Taxonomy_table_noKitLabSingletonCont_lowabundremoved_noUnclassDomain, "JS_clean_taxonomytable.csv")
